...
from .modules.natural_language_processing import nlp_processor
from .modules.action_handler import action_handler
from .modules.text_to_speech import text_to_speech_converter
...
class VoiceAssistant:
    def __init__(self):
        ...
        self.text_to_speech_converter = text_to_speech_converter.TextToSpeechConverter()
